...
var scenarioRegistry = map[string]scenarioBinding{ //nolint:gochecknoglobals // shared executable catalog
	...
	"sqlite_job_row_bytes":                                           {owner: scenarioOwnerSQLiteStorage, profile: "portable-storage-v1", tier: "storage"},
	...
	"sqlite_runtime_job_row_bytes":                                   {owner: scenarioOwnerSQLiteRuntime, profile: "sqlite-runtime-v1", tier: "mixed"},
