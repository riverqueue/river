...
func Test_Client_JobUpdate(t *testing.T) {
	...
	t.Run("MultipleOutputsError", func(t *testing.T) {
		t.Parallel()
		...
		require.EqualError(t, err, "should not set job output both from work context (via RecordOutput) and in JobUpdateParams")
	})
}
