...
CREATE TABLE /* TEMPLATE: schema */river_migration_new (
    line VARCHAR(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE /* TEMPLATE: schema */river_client (
    id VARCHAR(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL PRIMARY KEY,
    created_at DATETIME(6) NOT NULL DEFAULT (UTC_TIMESTAMP(6)),
...
CREATE TABLE /* TEMPLATE: schema */river_client_queue (
    river_client_id VARCHAR(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
