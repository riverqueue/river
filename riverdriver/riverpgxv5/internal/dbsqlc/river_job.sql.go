...
func (q *Queries) JobCancel(ctx context.Context, db DBTX, arg *JobCancelParams) (*RiverJob, error) {
	row := db.QueryRow(ctx, q.interpolateSchemaName(jobCancel), arg.ID, arg.ControlTopic, arg.CancelAttemptedAt)
	var i RiverJob
	err := row.Scan(
		&i.ID,
		&i.Args,
...
func (q *Queries) JobCountByState(ctx context.Context, db DBTX, state RiverJobState) (int64, error) {
	row := db.QueryRow(ctx, q.interpolateSchemaName(jobCountByState), state)
	var count int64
	err := row.Scan(&count)
	return count, err
}
...
func (q *Queries) JobDeleteBefore(ctx context.Context, db DBTX, arg *JobDeleteBeforeParams) (int64, error) {
	row := db.QueryRow(ctx, q.interpolateSchemaName(jobDeleteBefore),
...
func (q *Queries) JobGetAvailable(ctx context.Context, db DBTX, arg *JobGetAvailableParams) ([]*RiverJob, error) {
	rows, err := db.Query(ctx, q.interpolateSchemaName(jobGetAvailable), arg.AttemptedBy, arg.Queue, arg.Max)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) JobGetByID(ctx context.Context, db DBTX, id int64) (*RiverJob, error) {
	row := db.QueryRow(ctx, q.interpolateSchemaName(jobGetByID), id)
	var i RiverJob
	err := row.Scan(
		&i.ID,
		&i.Args,
...
func (q *Queries) JobGetByIDMany(ctx context.Context, db DBTX, id []int64) ([]*RiverJob, error) {
	rows, err := db.Query(ctx, q.interpolateSchemaName(jobGetByIDMany), id)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) JobGetByKindAndUniqueProperties(ctx context.Context, db DBTX, arg *JobGetByKindAndUniquePropertiesParams) (*RiverJob, error) {
	row := db.QueryRow(ctx, q.interpolateSchemaName(jobGetByKindAndUniqueProperties),
		arg.Kind,
		arg.ByArgs,
		arg.Args,
		arg.ByCreatedAt,
...
func (q *Queries) JobGetByKindMany(ctx context.Context, db DBTX, kind []string) ([]*RiverJob, error) {
	rows, err := db.Query(ctx, q.interpolateSchemaName(jobGetByKindMany), kind)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) JobGetStuck(ctx context.Context, db DBTX, arg *JobGetStuckParams) ([]*RiverJob, error) {
	rows, err := db.Query(ctx, q.interpolateSchemaName(jobGetStuck), arg.StuckHorizon, arg.Max)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) JobInsertFast(ctx context.Context, db DBTX, arg *JobInsertFastParams) (*RiverJob, error) {
	row := db.QueryRow(ctx, q.interpolateSchemaName(jobInsertFast),
		arg.Args,
		arg.FinalizedAt,
		arg.Kind,
		arg.MaxAttempts,
...
func (q *Queries) JobInsertFull(ctx context.Context, db DBTX, arg *JobInsertFullParams) (*RiverJob, error) {
	row := db.QueryRow(ctx, q.interpolateSchemaName(jobInsertFull),
		arg.Args,
		arg.Attempt,
		arg.AttemptedAt,
		arg.CreatedAt,
...
func (q *Queries) JobRescueMany(ctx context.Context, db DBTX, arg *JobRescueManyParams) error {
	_, err := db.Exec(ctx, q.interpolateSchemaName(jobRescueMany),
		arg.ID,
		arg.Error,
		arg.FinalizedAt,
		arg.ScheduledAt,
...
func (q *Queries) JobRetry(ctx context.Context, db DBTX, id int64) (*RiverJob, error) {
	row := db.QueryRow(ctx, q.interpolateSchemaName(jobRetry), id)
	var i RiverJob
	err := row.Scan(
		&i.ID,
		&i.Args,
...
func (q *Queries) JobSchedule(ctx context.Context, db DBTX, arg *JobScheduleParams) ([]*RiverJob, error) {
	rows, err := db.Query(ctx, q.interpolateSchemaName(jobSchedule), arg.Now, arg.Max)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) JobSetCompleteIfRunningMany(ctx context.Context, db DBTX, arg *JobSetCompleteIfRunningManyParams) ([]*RiverJob, error) {
	rows, err := db.Query(ctx, q.interpolateSchemaName(jobSetCompleteIfRunningMany), arg.ID, arg.FinalizedAt)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) JobSetStateIfRunning(ctx context.Context, db DBTX, arg *JobSetStateIfRunningParams) (*RiverJob, error) {
	row := db.QueryRow(ctx, q.interpolateSchemaName(jobSetStateIfRunning),
		arg.State,
		arg.ID,
...
func (q *Queries) JobUpdate(ctx context.Context, db DBTX, arg *JobUpdateParams) (*RiverJob, error) {
	row := db.QueryRow(ctx, q.interpolateSchemaName(jobUpdate),
		arg.AttemptDoUpdate,
		arg.Attempt,
