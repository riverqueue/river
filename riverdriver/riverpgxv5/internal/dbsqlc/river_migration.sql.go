...
func (q *Queries) RiverMigrationDeleteByVersionMany(ctx context.Context, db DBTX, version []int64) ([]*RiverMigration, error) {
	rows, err := db.Query(ctx, q.interpolateSchemaName(riverMigrationDeleteByVersionMany), version)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) RiverMigrationGetAll(ctx context.Context, db DBTX) ([]*RiverMigration, error) {
	rows, err := db.Query(ctx, q.interpolateSchemaName(riverMigrationGetAll))
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) RiverMigrationInsert(ctx context.Context, db DBTX, version int64) (*RiverMigration, error) {
	row := db.QueryRow(ctx, q.interpolateSchemaName(riverMigrationInsert), version)
	var i RiverMigration
...
func (q *Queries) RiverMigrationInsertMany(ctx context.Context, db DBTX, version []int64) ([]*RiverMigration, error) {
	rows, err := db.Query(ctx, q.interpolateSchemaName(riverMigrationInsertMany), version)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) TableExists(ctx context.Context, db DBTX, tableName string) (bool, error) {
	row := db.QueryRow(ctx, q.interpolateSchemaName(tableExists), tableName)
	var column_1 bool
