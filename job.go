...
type (
	// InsertOpts was originally in the top-level river package, but moved so it
	// could be accessible by subpackages. Prefer using the one in rivertype.
	InsertOpts = rivertype.InsertOpts

	// JobArgs was originally in the top-level river package, but moved so it
	// could be accessible by subpackages. Prefer using the one in rivertype.
	JobArgs = rivertype.JobArgs

	// UniqueOpts was originally in the top-level river package, but moved so it
	// could be accessible by subpackages. Prefer using the one in rivertype.
	UniqueOpts = rivertype.UniqueOpts
)
